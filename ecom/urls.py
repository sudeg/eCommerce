...
urlpatterns = [
    ...
    path('onepage-carousel/', views.OnePageCarouselView.as_view(),name='onepage-carousel'),
    path('onepage-image/', views.OnePageImageView.as_view(), name='onepage-image'),
    path('onepage-sidebarmenu/', views.OnePageSidebarMenuView.as_view(),name='onepage-sidebarmenu'),
    path('onepage-slider/', views.OnePageSliderView.as_view(), name='onepage-slider'),
    path('onepage-slideshow/', views.OnePageSlideshowView.as_view(),name='onepage-slideshow'),
    ...
    path('portfolio-single/', views.PortfolioSingleView.as_view(),name='portfolio-single'),
    path('portfolio-single2/', views.PortfolioSingle2View.as_view(),name='portfolio-single2'),
    path('portfolio-single3/', views.PortfolioSingle3View.as_view(),name='portfolio-single3'),
    path('portfolio-single4/', views.PortfolioSingle4View.as_view(),name='portfolio-single4'),
    path('portfolio-single5/', views.PortfolioSingle5View.as_view(),name='portfolio-single5'),
    path('portfolio-single6/', views.PortfolioSingle6View.as_view(),name='portfolio-single6'),
